...
//  Pachinko
//
//  Created by Cumali Han Ünlü on 13.10.2019.
      ...
      if objects.contains(editLabel){
        editingMode.toggle()
         ...
         if editingMode{
            ...
            let randomBall = ["ballRed","ballCyan","ballGreen","ballBlue","ballPurple","ballYellow","ballGrey"]
            let ball = SKSpriteNode(imageNamed: randomBall.randomElement()!)
